...
public class UIService : IUIService
{
    public UIService()
    {
        ...
        _panel = PanelMgmt.Create(PanelGroupsDictionary, PanelsDictionary);
        ...
        _section = SectionMgmt.Create(SectionedPagesDictionary, SectionsDictionary);
    }

    private readonly IAnimMgmt _anim;
    private readonly INavMgmt _nav;
    private readonly IPanelMgmt _panel;
    private readonly ISectionMgmt _section;
    ...
    public void NavigateToSection(Sec sectionId, bool triggersOnPanelMgmtUpdated = true)
    {
    ...
    {
        _panel.UpdatePanelsWhenNavigating(panelId);
        RaiseEventOnUiServiceChanged();
    }
    ...
    public SectionedPage SectionedPage(int sectionId) =>
        _section.SectionedPages[sectionId];
    ...
    public Section Section(int sectionId) =>
        _section.Sections[sectionId];

    public Panel Panel(int panelId) =>
