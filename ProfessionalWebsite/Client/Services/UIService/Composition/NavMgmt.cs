...
public class NavMgmt : INavMgmt
{
    ...
    */
    ...
    public void NavigateToSection(Sec sectionId, IPanelMgmt panelMgmt, ISectionMgmt sectionMgmt)
    {
    ...
    public void NavigateToHardCodedPage(int hardcodedPanelId, int navGroupPanelId, IPanelMgmt panelMgmt)
    {
