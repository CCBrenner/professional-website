...
public class NavMgmt : INavMgmt
{
    ...
    */
    ...
    public void NavigateToSection(int sectionId, Dictionary<int, Panel> panels, Dictionary<int, PanelGroup> panelGroups, Dictionary<int, Section> sections, Dictionary<int, SectionedPage> sectionedPages)
    {
        try
        {
    ...
    public void NavigateToHardCodedPage(int hardcodedPanelId, int navGroupPanelId, Dictionary<int, Panel> panels, Dictionary<int, PanelGroup> panelGroups)
    {
