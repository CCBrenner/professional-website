...
{
    private Section(string id, int sectionedPageId, bool isFirstSectionOfPage = false)
    {
        Id = id;
    ...
    public static Section Create(string id, int sectionedPageId, bool isFirstSectionOfPage = false) =>
