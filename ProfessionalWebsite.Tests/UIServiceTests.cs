...
public class UIServiceTests
{
    ...
    public void TestClickingAnimationButtonPlaysAnimationOneTimePerSpecificUseCase()
    {
        ...
        Assert.AreEqual("", uIService.Anim.AnimateMain);
        Assert.AreEqual("", uIService.Panel.Panels[8].PanelStatus);
        ...
        Assert.AreEqual("main1", uIService.Anim.AnimateMain);
        Assert.AreEqual("", uIService.Panel.Panels[8].PanelStatus);
    }
    ...
    public void TestClickingAnimationButtonPlaysAnimationContinuouslyPerSpecificUseCase()
    {
        ...
        Assert.AreEqual("main1-infinite", uIService.Anim.AnimateMain);
        Assert.AreEqual("discontinue-button-on", uIService.Panel.Panels[8].PanelStatus);
    }
    ...
    public void TestClickingAnimationButtonAnimatesMainOneTimeBasedOnAnimationsSpecificConfiguration()
    {
        ...
        Assert.AreEqual("", uIService.Anim.AnimateMain);
        Assert.AreEqual("", uIService.Panel.Panels[8].PanelStatus);
        Assert.AreEqual(false, uIService.Anim.IsContinuous[0]);
    ...
    public void TestClickingAnimationButtonAnimatesMainContinuouslyBasedOnAnimationsSpecificConfiguration()
    {
        ...
        Assert.AreEqual("", uIService.Anim.AnimateMain);
        Assert.AreEqual("", uIService.Panel.Panels[8].PanelStatus);
        var IsContinuousList = uIService.Anim.IsContinuous;
        IsContinuousList[0] = true;
        Assert.AreEqual(true, uIService.Anim.IsContinuous[0]);
    ...
    public void TestClickingAnElementThatNavigatesToASectionChangesLocationPanelIdToThePanelIdOfTheDestinationPage()
    {
        ...
        Assert.AreEqual(4, uIService.Panel.PanelGroups[0].LocationPanelId);
        ...
        Assert.AreEqual(3, uIService.Panel.PanelGroups[0].LocationPanelId);
    }
    ...
    public void TestClickingAnElementThatNavgiatesToASectionPromotesItAndDoesNotPromoteAnyOtherSections ()
    {
        ...
        Assert.AreEqual(false, uIService._section.Sections[13].IsCurrentPromo);
        Assert.AreEqual(false, uIService._section.Sections[4].IsCurrentPromo);
        Assert.AreEqual(false, uIService._section.Sections[14].IsCurrentPromo);
        Assert.AreEqual(false, uIService._section.Sections[33].IsCurrentPromo);
        ...
        Assert.AreEqual(true, uIService._section.Sections[13].IsCurrentPromo);
        Assert.AreEqual(false, uIService._section.Sections[4].IsCurrentPromo);
        Assert.AreEqual(false, uIService._section.Sections[14].IsCurrentPromo);
        Assert.AreEqual(false, uIService._section.Sections[33].IsCurrentPromo);
    }
    ...
    public void TestClickingHeaderOfClosedSectionWhenAllSectionsAreCollapsedSwitchesFromUsingSectionsToUsingHeaderClones()
    {
        ...
        Assert.AreEqual(false, uIService._section.SectionedPages[1].ASectionIsCurrentlyPromo);
        ...
        Assert.AreEqual(true, uIService._section.SectionedPages[1].ASectionIsCurrentlyPromo);
    }
    ...
    public void TestClickingHeaderOfClosedSectionWhenAllOtherSectionsAreClosedPromotesTheSection()
    {
        ...
        uIService.ToggleAllSections(1);
        Assert.AreEqual(false, uIService._section.Sections[13].IsCurrentPromo);
        Assert.AreEqual(true, uIService._section.Sections[13].IsCollapsed);
        Assert.AreEqual(true, uIService._section.Sections[4].IsCollapsed);
        Assert.AreEqual(true, uIService._section.Sections[7].IsCollapsed);
        Assert.AreEqual(true, uIService._section.Sections[16].IsCollapsed);
        Assert.AreEqual(false, uIService._section.SectionedPages[1].ASectionIsCurrentlyPromo);
    ...
    public void TestClickingMassToggleToolForSectionsWhenAllSectionsAreOpenCollapsesAllSections()
    {
        ...
        uIService.NavigateToSection(13);
        uIService.ToggleAllSections(1);
        Assert.AreEqual(false, uIService._section.Sections[1].IsCollapsed);
        Assert.AreEqual(false, uIService._section.Sections[4].IsCollapsed);
        Assert.AreEqual(false, uIService._section.Sections[7].IsCollapsed);
        Assert.AreEqual(false, uIService._section.Sections[16].IsCollapsed);
        ...
        Assert.AreEqual(true, uIService._section.Sections[1].IsCollapsed);
        Assert.AreEqual(true, uIService._section.Sections[4].IsCollapsed);
        Assert.AreEqual(true, uIService._section.Sections[7].IsCollapsed);
        Assert.AreEqual(true, uIService._section.Sections[16].IsCollapsed);
    }
    ...
    public void TestClickingAnElementThatOpensAHardCodedPageMakesThePageAppear()
    {
        ...
        Assert.AreNotEqual("", uIService.Panel.Panels[hardcodedPagePanelId].PanelStatus);
        Assert.AreEqual(true, uIService.Panel.Panels[hardcodedPagePanelId].PanelIsActive);
        Assert.AreNotEqual("", uIService.Panel.Panels[hardcodedPagePanelId].BehindPanelStatus);
        Assert.AreEqual(true, uIService.Panel.Panels[hardcodedPagePanelId].BehindPanelIsActive);
    }
    ...
    public void TestClickingAnElementThatOpensAHardcodedPageUpdatesTheNavLocationPanelReferenceToTheHardcodedPagesDefinedPageLocation()
    {
        ...
        Assert.AreEqual(3, uIService.Panel.PanelGroups[navpanelGroupId].LocationPanelId);
        ...
        Assert.AreEqual(4, uIService.Panel.PanelGroups[navpanelGroupId].LocationPanelId);
    }
    ...
    public void TestClickingANavigationElementWhenOnAHardcodedPageClosesTheHardcodedPageAndBehindPanel()
    {
        ...
        Assert.AreEqual("", uIService.Panel.Panels[hardcodedPagePanelId].PanelStatus);
        Assert.AreEqual(false, uIService.Panel.Panels[hardcodedPagePanelId].PanelIsActive);
        Assert.AreEqual("", uIService.Panel.Panels[hardcodedPagePanelId].BehindPanelStatus);
        Assert.AreEqual(false, uIService.Panel.Panels[hardcodedPagePanelId].BehindPanelIsActive);
    }
    ...
    public void TestClickingAnElementThatTogglesACooperativePanelMakesItActive()
    {
        ...
        Assert.AreEqual("", uIService.Panel.Panels[0].PanelStatus);
        Assert.AreEqual(false, uIService.Panel.Panels[0].PanelIsActive);
        Assert.AreEqual("", uIService.Panel.Panels[0].BehindPanelStatus);
        Assert.AreEqual(false, uIService.Panel.Panels[0].BehindPanelIsActive);
        Assert.AreEqual("", uIService.Panel.Panels[0].BlurStatus);
        Assert.AreEqual(false, uIService.Panel.Panels[0].BlurIsActive);
        Assert.AreEqual("", uIService.Panel.Panels[0].PanelButtonStatus);
        Assert.AreEqual(false, uIService.Panel.Panels[0].PanelButtonIsActive);
        ...
        Assert.AreNotEqual("", uIService.Panel.Panels[0].PanelStatus);
        Assert.AreEqual(true, uIService.Panel.Panels[0].PanelIsActive);
        Assert.AreNotEqual("", uIService.Panel.Panels[0].BehindPanelStatus);
        Assert.AreEqual(true, uIService.Panel.Panels[0].BehindPanelIsActive);
        Assert.AreNotEqual("", uIService.Panel.Panels[0].BlurStatus);
        Assert.AreEqual(true, uIService.Panel.Panels[0].BlurIsActive);
        Assert.AreNotEqual("", uIService.Panel.Panels[0].PanelButtonStatus);
        Assert.AreEqual(true, uIService.Panel.Panels[0].PanelButtonIsActive);
    }
    ...
    public void TestClickingAnElementThatTogglesACooperativePanelFromOffToOnHidesAllOtherPanels()
    {
        ...
        var panelZero = uIService.Panel.Panels[0];
        var panelOne = uIService.Panel.Panels[1];
        var panelTwo = uIService.Panel.Panels[2];
    ...
    public void TestClickingAnElementThatTogglesACooperativePanelFromOffToOnDoesNotCloseAnIndependentPanel()
    {
        ...
        var panelZero = uIService.Panel.Panels[0];
        var panelSeven = uIService.Panel.Panels[7];
        var panelEight = uIService.Panel.Panels[8];
    ...
    public void TestClickingAnElementThatTogglesAnIndependentPanelFromOffToOnMakesBothCoopPanelsInactive()
    {
        ...
        var panelEight = uIService.Panel.Panels[8];  // independent
        var panelZero = uIService.Panel.Panels[0];  // cooperative
        var panelOne = uIService.Panel.Panels[1];  // cooperative
    ...
    public void TestClickingPanelToggleForSecondIndependentPanelDoesNotHideFirstActiveIndependentPanel()
    {
        ...
        var panelSeven = uIService.Panel.Panels[7];  // independent
        var panelEight = uIService.Panel.Panels[8];  // independent
