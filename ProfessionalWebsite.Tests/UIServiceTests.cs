...
namespace ProfessionalWebsite.Tests
{
    ...
    public class UIServiceTests
    {
        ...
        public void TestClickingAnElementThatNavgiatesToASectionPromotesItAndDoesNotPromoteAnyOtherSections ()
        {
            ...
            Assert.AreEqual(false, uIService.Section.Sections[13].IsCurrentPromo);
            Assert.AreEqual(false, uIService.Section.Sections[4].IsCurrentPromo);
            Assert.AreEqual(false, uIService.Section.Sections[14].IsCurrentPromo);
            Assert.AreEqual(false, uIService.Section.Sections[33].IsCurrentPromo);
            ...
            Assert.AreEqual(true, uIService.Section.Sections[13].IsCurrentPromo);
            Assert.AreEqual(false, uIService.Section.Sections[4].IsCurrentPromo);
            Assert.AreEqual(false, uIService.Section.Sections[14].IsCurrentPromo);
            Assert.AreEqual(false, uIService.Section.Sections[33].IsCurrentPromo);
        }
        ...
        public void TestClickingHeaderOfClosedSectionWhenAllSectionsAreCollapsedSwitchesFromUsingSectionsToUsingHeaderClones()
        {
            ...
            Assert.AreEqual(false, uIService.Section.SectionedPages[1].ASectionIsCurrentlyPromo);
            ...
            Assert.AreEqual(true, uIService.Section.SectionedPages[1].ASectionIsCurrentlyPromo);
        }
        ...
        public void TestClickingHeaderOfClosedSectionWhenAllOtherSectionsAreClosedPromotesTheSection()
        {
            ...
            uIService.ToggleAllSections(1);
            Assert.AreEqual(false, uIService.Section.Sections[13].IsCurrentPromo);
            Assert.AreEqual(true, uIService.Section.Sections[13].IsCollapsed);
            Assert.AreEqual(true, uIService.Section.Sections[4].IsCollapsed);
            Assert.AreEqual(true, uIService.Section.Sections[7].IsCollapsed);
            Assert.AreEqual(true, uIService.Section.Sections[16].IsCollapsed);
            Assert.AreEqual(false, uIService.Section.SectionedPages[1].ASectionIsCurrentlyPromo);
        ...
        public void TestClickingMassToggleToolForSectionsWhenAllSectionsAreOpenCollapsesAllSections()
        {
            ...
            uIService.NavigateToSection(13);
            uIService.ToggleAllSections(1);
            Assert.AreEqual(false, uIService.Section.Sections[1].IsCollapsed);
            Assert.AreEqual(false, uIService.Section.Sections[4].IsCollapsed);
            Assert.AreEqual(false, uIService.Section.Sections[7].IsCollapsed);
            Assert.AreEqual(false, uIService.Section.Sections[16].IsCollapsed);
            ...
            Assert.AreEqual(true, uIService.Section.Sections[1].IsCollapsed);
            Assert.AreEqual(true, uIService.Section.Sections[4].IsCollapsed);
            Assert.AreEqual(true, uIService.Section.Sections[7].IsCollapsed);
            Assert.AreEqual(true, uIService.Section.Sections[16].IsCollapsed);
        }
