...
namespace ProfessionalWebsite.Tests
{
    ...
    public class UIServiceTests
    {
        ...
        public void TestClickingAnimationButtonPlaysAnimationOneTimePerSpecificUseCase()
        {
            ...
            Assert.AreEqual("", uIService.AnimMgmt.AnimateMain);
            Assert.AreEqual("", uIService.PanelMgmt.Panels[8].PanelStatus);
            ...
            Assert.AreEqual("main1", uIService.AnimMgmt.AnimateMain);
            Assert.AreEqual("", uIService.PanelMgmt.Panels[8].PanelStatus);
        }
        ...
        public void TestClickingAnimationButtonPlaysAnimationContinuouslyPerSpecificUseCase()
        {
            ...
            Assert.AreEqual("main1-infinite", uIService.AnimMgmt.AnimateMain);
            Assert.AreEqual("discontinue-button-on", uIService.PanelMgmt.Panels[8].PanelStatus);
        }
        ...
        public void TestClickingAnimationButtonAnimatesMainOneTimeBasedOnAnimationsSpecificConfiguration()
        {
            ...
            Assert.AreEqual("", uIService.AnimMgmt.AnimateMain);
            Assert.AreEqual("", uIService.PanelMgmt.Panels[8].PanelStatus);
            Assert.AreEqual(false, uIService.AnimMgmt.IsContinuous[0]);
        ...
        public void TestClickingAnimationButtonAnimatesMainContinuouslyBasedOnAnimationsSpecificConfiguration()
        {
            ...
            Assert.AreEqual("", uIService.AnimMgmt.AnimateMain);
            Assert.AreEqual("", uIService.PanelMgmt.Panels[8].PanelStatus);
            var IsContinuousList = uIService.AnimMgmt.IsContinuous;
            IsContinuousList[0] = true;
            Assert.AreEqual(true, uIService.AnimMgmt.IsContinuous[0]);
        ...
        public void TestClickingAnElementThatNavigatesToASectionChangesLocationPanelIdToThePanelIdOfTheDestinationPage()
        {
            ...
            Assert.AreEqual(4, uIService.PanelMgmt.PanelGroups[0].LocationPanelId);
            ...
            Assert.AreEqual(3, uIService.PanelMgmt.PanelGroups[0].LocationPanelId);
        }
        ...
        public void TestClickingAnElementThatNavgiatesToASectionPromotesItAndDoesNotPromoteAnyOtherSections ()
        {
            ...
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[13].IsCurrentPromo);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[4].IsCurrentPromo);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[14].IsCurrentPromo);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[33].IsCurrentPromo);
            ...
            Assert.AreEqual(true, uIService.SectionMgmt.Sections[13].IsCurrentPromo);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[4].IsCurrentPromo);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[14].IsCurrentPromo);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[33].IsCurrentPromo);
        }
        ...
        public void TestClickingHeaderOfClosedSectionWhenAllSectionsAreCollapsedSwitchesFromUsingSectionsToUsingHeaderClones()
        {
            ...
            Assert.AreEqual(false, uIService.SectionMgmt.SectionedPages[1].ASectionIsCurrentlyPromo);
            ...
            Assert.AreEqual(true, uIService.SectionMgmt.SectionedPages[1].ASectionIsCurrentlyPromo);
        }
        ...
        public void TestClickingHeaderOfClosedSectionWhenAllOtherSectionsAreClosedPromotesTheSection()
        {
            ...
            uIService.ToggleAllSections(1);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[13].IsCurrentPromo);
            Assert.AreEqual(true, uIService.SectionMgmt.Sections[13].IsCollapsed);
            Assert.AreEqual(true, uIService.SectionMgmt.Sections[4].IsCollapsed);
            Assert.AreEqual(true, uIService.SectionMgmt.Sections[7].IsCollapsed);
            Assert.AreEqual(true, uIService.SectionMgmt.Sections[16].IsCollapsed);
            Assert.AreEqual(false, uIService.SectionMgmt.SectionedPages[1].ASectionIsCurrentlyPromo);
        ...
        public void TestClickingMassToggleToolForSectionsWhenAllSectionsAreOpenCollapsesAllSections()
        {
            ...
            uIService.NavigateToSection(13);
            uIService.ToggleAllSections(1);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[1].IsCollapsed);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[4].IsCollapsed);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[7].IsCollapsed);
            Assert.AreEqual(false, uIService.SectionMgmt.Sections[16].IsCollapsed);
            ...
            Assert.AreEqual(true, uIService.SectionMgmt.Sections[1].IsCollapsed);
            Assert.AreEqual(true, uIService.SectionMgmt.Sections[4].IsCollapsed);
            Assert.AreEqual(true, uIService.SectionMgmt.Sections[7].IsCollapsed);
            Assert.AreEqual(true, uIService.SectionMgmt.Sections[16].IsCollapsed);
        }
        ...
        public void TestClickingAnElementThatOpensAHardCodedPageMakesThePageAppear()
        {
            ...
            Assert.AreNotEqual("", uIService.PanelMgmt.Panels[hardcodedPagePanelId].PanelStatus);
            Assert.AreEqual(true, uIService.PanelMgmt.Panels[hardcodedPagePanelId].PanelIsActive);
            Assert.AreNotEqual("", uIService.PanelMgmt.Panels[hardcodedPagePanelId].BehindPanelStatus);
            Assert.AreEqual(true, uIService.PanelMgmt.Panels[hardcodedPagePanelId].BehindPanelIsActive);
        }
        ...
        public void TestClickingAnElementThatOpensAHardcodedPageUpdatesTheNavLocationPanelReferenceToTheHardcodedPagesDefinedPageLocation()
        {
            ...
            Assert.AreEqual(3, uIService.PanelMgmt.PanelGroups[navpanelGroupId].LocationPanelId);
            ...
            Assert.AreEqual(4, uIService.PanelMgmt.PanelGroups[navpanelGroupId].LocationPanelId);
        }
        ...
        public void TestClickingANavigationElementWhenOnAHardcodedPageClosesTheHardcodedPageAndBehindPanel()
        {
            ...
            Assert.AreEqual("", uIService.PanelMgmt.Panels[hardcodedPagePanelId].PanelStatus);
            Assert.AreEqual(false, uIService.PanelMgmt.Panels[hardcodedPagePanelId].PanelIsActive);
            Assert.AreEqual("", uIService.PanelMgmt.Panels[hardcodedPagePanelId].BehindPanelStatus);
            Assert.AreEqual(false, uIService.PanelMgmt.Panels[hardcodedPagePanelId].BehindPanelIsActive);
        }
        ...
        public void TestClickingAnElementThatTogglesACooperativePanelMakesItActive()
        {
            ...
            Assert.AreEqual("", uIService.PanelMgmt.Panels[0].PanelStatus);
            Assert.AreEqual(false, uIService.PanelMgmt.Panels[0].PanelIsActive);
            Assert.AreEqual("", uIService.PanelMgmt.Panels[0].BehindPanelStatus);
            Assert.AreEqual(false, uIService.PanelMgmt.Panels[0].BehindPanelIsActive);
            Assert.AreEqual("", uIService.PanelMgmt.Panels[0].BlurStatus);
            Assert.AreEqual(false, uIService.PanelMgmt.Panels[0].BlurIsActive);
            Assert.AreEqual("", uIService.PanelMgmt.Panels[0].PanelButtonStatus);
            Assert.AreEqual(false, uIService.PanelMgmt.Panels[0].PanelButtonIsActive);
            ...
            Assert.AreNotEqual("", uIService.PanelMgmt.Panels[0].PanelStatus);
            Assert.AreEqual(true, uIService.PanelMgmt.Panels[0].PanelIsActive);
            Assert.AreNotEqual("", uIService.PanelMgmt.Panels[0].BehindPanelStatus);
            Assert.AreEqual(true, uIService.PanelMgmt.Panels[0].BehindPanelIsActive);
            Assert.AreNotEqual("", uIService.PanelMgmt.Panels[0].BlurStatus);
            Assert.AreEqual(true, uIService.PanelMgmt.Panels[0].BlurIsActive);
            Assert.AreNotEqual("", uIService.PanelMgmt.Panels[0].PanelButtonStatus);
            Assert.AreEqual(true, uIService.PanelMgmt.Panels[0].PanelButtonIsActive);
        }
        ...
        public void TestClickingAnElementThatTogglesACooperativePanelFromOffToOnHidesAllOtherPanels()
        {
            ...
            var panelZero = uIService.PanelMgmt.Panels[0];
            var panelOne = uIService.PanelMgmt.Panels[1];
            var panelTwo = uIService.PanelMgmt.Panels[2];
        ...
        public void TestClickingAnElementThatTogglesACooperativePanelFromOffToOnDoesNotCloseAnIndependentPanel()
        {
            ...
            var panelZero = uIService.PanelMgmt.Panels[0];
            var panelSeven = uIService.PanelMgmt.Panels[7];
            var panelEight = uIService.PanelMgmt.Panels[8];
        ...
        public void TestClickingAnElementThatTogglesAnIndependentPanelFromOffToOnMakesBothCoopPanelsInactive()
        {
            ...
            var panelEight = uIService.PanelMgmt.Panels[8];  // independent
            var panelZero = uIService.PanelMgmt.Panels[0];  // cooperative
            var panelOne = uIService.PanelMgmt.Panels[1];  // cooperative
        ...
        public void TestClickingPanelToggleForSecondIndependentPanelDoesNotHideFirstActiveIndependentPanel()
        {
            ...
            var panelSeven = uIService.PanelMgmt.Panels[7];  // independent
            var panelEight = uIService.PanelMgmt.Panels[8];  // independent
